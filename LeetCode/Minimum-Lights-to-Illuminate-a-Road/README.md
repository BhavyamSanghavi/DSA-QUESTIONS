...
Can you solve this real interview question? Minimum Lights to Illuminate a Road - You are given an integer array lights of length n, representing positions 0 through n - 1 on a road.
